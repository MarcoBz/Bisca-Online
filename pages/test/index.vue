...
<script>
import CreateMatch from '~/components/test/CreateMatch.vue'
import MatchRow from '~/components/test/MatchRow.vue'
import MatchTableHead from '~/components/test/MatchTableHead.vue'
export default {
  components: {
    CreateMatch,
    MatchTableHead,
