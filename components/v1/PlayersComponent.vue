...
<script>
import Card from "~/components/v1/Card.vue"
import Nuke from "~/components/v1/Nuke.vue"
import NukeNotice from "~/components/v1/NukeNotice.vue"
import ZombieNotice from "~/components/v1/ZombieNotice.vue"
import ExplosionNotice from "~/components/v1/ExplosionNotice.vue"
import Trophy from "~/components/v1/Trophy.vue"
export default {
  components: {
    Trophy,
    Nuke,
